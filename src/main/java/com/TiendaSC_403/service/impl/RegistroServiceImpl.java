...
import com.TiendaSC_403.service.CorreoService;
import com.TiendaSC_403.service.RegistroService;
import com.TiendaSC_403.service.UsuarioService;
...
public class RegistroServiceImpl implements RegistroService {
    ...
    public Model crearUsuario(Model model, Usuario usuario) 
        ...
        String mensaje;
        if (!usuarioService.
                existeUsuarioPorUsernameOCorreo(//validar si existe un usuario antes de crear correo
                        usuario.getUsername(), 
                        usuario.getCorreo())) {
